...
?>
    ...
    <body>
           <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white; background-color: maroon;">
        <div class="container">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>Welcome to THP Car And Bike </span>
                </h1>
                <br>
