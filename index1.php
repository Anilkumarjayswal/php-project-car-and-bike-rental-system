                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">THP CAR RENTAL</h1>
                            <p class="intro-text">
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> MAULPUR, India<br>
                ...
                <p>New to THP ? Drop Your Details and Leave it on us We'll Revert</p>
