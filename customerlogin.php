...
?>
    ...
    <body background="assets/img/bike.jfif">
                 <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white; background-color: red;">
        <div class="container">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>THP Car And Bike Rental Service </span>
                </h1>
                <br>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5 style="color: white;">© 2020 THP Car And Bike Rental Service</h5>
                </div>
            </div>
        </div>
    </footer>
